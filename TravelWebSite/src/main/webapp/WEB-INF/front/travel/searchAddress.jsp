	...
	<div class="container">
		<div class="row clearfix" >
			<div class="col-md-12 column "
				...
				<form id="queryAddressListForm" class="navbar-form navbar-left" role="search" action="${ctx}/travel/searchAddress.do" method="post">
...
<div class="container">
		...
		<c:forEach items="${page.items }" var="f"
        		...
        		<div class="pic pic1">
					<div class="item">
						<a href="#"> <img src="${ctx }${f.url}" class="img01" />
							<div class="img02" style="color:#019875;">${f.name }</div>
						</a>
					</div>
						<div class="item a" style="color:#428bca;">${f.information }</div>
				</div>
